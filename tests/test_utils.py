...
class TestIsEnabled:
    ...
    def test_is_enabled_with_specific_extensions(self):
    ...
    def test_is_enabled_with_path_object(self):
...
class TestGetJsFiles:
    ...
    def test_get_js_files_finds_minified_first(self, mock_is_enabled, mock_path):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            mock_path.__truediv__.return_value = temp_path / 'extensions'
    ...
    def test_get_js_files_collapsible_runner(self, mock_is_enabled, mock_path):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert any('collapsible-runner' in str(js_file) for js_file in js_files)

    @patch('django_simple_bulma.utils.simple_bulma_path')
    @patch('django_simple_bulma.utils.is_enabled')
    def test_get_js_files_no_enabled_extensions(self, mock_is_enabled, mock_path):
...
class TestGetSassFiles:
    ...
    def test_get_sass_files_prioritizes_all_sass(self):
    ...
    def test_get_sass_files_falls_back_to_index(self):
    ...
    def test_get_sass_files_handles_css_files(self):
    ...
    def test_get_sass_files_no_stylesheets(self):
...
class TestSettingsLoading:
    ...
    def test_theme_detection_regex(self):
...
class TestModuleConstants:
    ...
    def test_simple_bulma_path_exists(self):
    ...
    def test_sass_files_searches_structure(self):
