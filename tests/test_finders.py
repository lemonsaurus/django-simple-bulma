...
class TestSimpleBulmaFinderInit:
    ...
    def test_init_other_finders(self):
...
class TestSimpleBulmaFinderStaticMethods:
    ...
    def test_get_extension_imports(self, mock_get_sass, mock_is_enabled, mock_path):
    ...
    def test_unpack_variables(self):
    ...
    def test_unpack_variables_empty(self):
    ...
    def test_get_bulma_js(self, mock_get_js_files):
    ...
    def test_find_relative_staticfiles(self):
    ...
    def test_find_relative_staticfiles_not_found(self):
...
class TestSimpleBulmaFinderCustomScss:
    ...
    def test_get_custom_css_file_not_found(self):
    ...
    @patch('django_simple_bulma.finders.simple_bulma_path')
    @patch('builtins.open', new_callable=mock_open)
    def test_get_custom_css_successful_compilation(self, mock_file, mock_path, mock_sass):
...
class TestSimpleBulmaFinderPublicMethods:
    ...
    def test_find_method_single_result(self):
    ...
    def test_find_method_find_all_parameter(self):
    ...
    def test_find_method_all_parameter(self):
    ...
    def test_list_method(self, mock_js, mock_custom, mock_css):
